# Generated by Django 2.2.10 on 2020-10-31 00:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Название приюта', max_length=40, verbose_name='Название приюта')),
                ('address', models.CharField(help_text='Адресс приюта', max_length=100, verbose_name='Адресс приюта')),
                ('prefecture', models.CharField(help_text='Подчинение (например: Префектура ЮВАО)', max_length=80, verbose_name='Подчинение')),
                ('phone_number', models.CharField(blank=True, help_text='Номер телефона', max_length=20, null=True, verbose_name='Номер телефона')),
            ],
        ),
        migrations.RenameField(
            model_name='animal',
            old_name='animal_birth_date',
            new_name='birth_date',
        ),
        migrations.RenameField(
            model_name='animal',
            old_name='animal_kind',
            new_name='kind',
        ),
        migrations.RenameField(
            model_name='animal',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='Адрес места отлова', max_length=15, null=True, verbose_name='Адрес места отлова'),
        ),
        migrations.AddField(
            model_name='animal',
            name='color',
            field=models.CharField(choices=[('светло коричневый', 'светло коричневый'), ('черепаховый', 'черепаховый'), ('красный', 'красный'), ('дымчатый', 'дымчатый'), ('перец с солью', 'перец с солью'), ('абрикосовый', 'абрикосовый'), ('кремовый', 'кремовый'), ('голубой с белым', 'голубой с белым'), ('голубой с пятнами', 'голубой с пятнами'), ('палевый', 'палевый'), ('чалый', 'чалый'), ('голубой  с подпалом', 'голубой  с подпалом'), ('пегий', 'пегий'), ('биколор (черный/красный)', 'биколор (черный/красный)'), ('дымчатый золотистый', 'дымчатый золотистый'), ('черный', 'черный'), ('темно коричневый', 'темно коричневый'), ('соболиный', 'соболиный'), ('рыжий', 'рыжий'), ('триколор (красный/черный/лиловый)', 'триколор (красный/черный/лиловый)'), ('золотой', 'золотой'), ('серебристый', 'серебристый'), ('фавн (бежевый)', 'фавн (бежевый)'), ('черно-белый', 'черно-белый'), ('голубой', 'голубой'), ('коричневый', 'коричневый'), ('шиншилла', 'шиншилла'), ('красный с белым', 'красный с белым'), ('молочный', 'молочный'), ('волчий', 'волчий'), ('тигровый', 'тигровый'), ('черный с белым', 'черный с белым'), ('лиловый с белым', 'лиловый с белым'), ('арлекин', 'арлекин'), ('бледно-желтый', 'бледно-желтый'), ('светло-коричневый', 'светло-коричневый'), ('черно-красный-белый', 'черно-красный-белый'), ('биколор', 'биколор'), ('мраморный', 'мраморный'), ('муругий', 'муругий'), ('белый', 'белый'), ('циннамон (корица)', 'циннамон (корица)'), ('лиловый', 'лиловый'), ('чепрачный', 'чепрачный'), ('голубо-кремовый черепаховый', 'голубо-кремовый черепаховый'), ('шоколадный', 'шоколадный')], default='черный', help_text='Цвет', max_length=25, verbose_name='Цвет'),
        ),
        migrations.AddField(
            model_name='animal',
            name='doctor_name',
            field=models.CharField(blank=True, help_text='ФИО вет. врача', max_length=50, null=True, verbose_name='ФИО врача'),
        ),
        migrations.AddField(
            model_name='animal',
            name='ears',
            field=models.CharField(choices=[('Стоячие ', 'Стоячие '), ('Полустоячие ', 'Полустоячие '), ('Висячие ', 'Висячие '), ('Купированные', 'Купированные')], default='стоячие', help_text='Уши', max_length=25, verbose_name='Уши'),
        ),
        migrations.AddField(
            model_name='animal',
            name='entrance_act',
            field=models.CharField(help_text='Акт о поступлении', max_length=15, null=True, verbose_name='Акт о поступлении'),
        ),
        migrations.AddField(
            model_name='animal',
            name='entrance_act_date',
            field=models.DateTimeField(help_text='Акт о поступлении. Дата', null=True, verbose_name='Акт о поступлении. Дата'),
        ),
        migrations.AddField(
            model_name='animal',
            name='hair',
            field=models.CharField(choices=[('Обычная ', 'Обычная '), ('Длинная', 'Длинная'), ('Гладкая', 'Гладкая'), ('Вьющаяся', 'Вьющаяся'), ('Жесткая ', 'Жесткая '), ('Бесшерстная', 'Бесшерстная'), ('Нетипичная', 'Нетипичная'), ('Короткая', 'Короткая')], default='обычная', help_text='Шерсть', max_length=25, verbose_name='Шерсть'),
        ),
        migrations.AddField(
            model_name='animal',
            name='identifying_marks',
            field=models.CharField(default='нет', help_text='Особые приметы', max_length=50, verbose_name='Особые приметы'),
        ),
        migrations.AddField(
            model_name='animal',
            name='leaving_act',
            field=models.CharField(blank=True, help_text='Акт о выбытии', max_length=15, null=True, verbose_name='Акт о выбытии'),
        ),
        migrations.AddField(
            model_name='animal',
            name='leaving_act_date',
            field=models.DateTimeField(blank=True, help_text='Дата выбытия', null=True, verbose_name='Дата выбытия'),
        ),
        migrations.AddField(
            model_name='animal',
            name='leaving_act_reason',
            field=models.CharField(blank=True, choices=[('Смерть', 'Смерть'), ('Передача в собственность (под опеку)', 'Передача в собственность (под опеку)')], help_text='Причина выбытия', max_length=1, null=True, verbose_name='Причина выбытия'),
        ),
        migrations.AddField(
            model_name='animal',
            name='legal_entity',
            field=models.CharField(blank=True, help_text='Юридическое лицо', max_length=15, null=True, verbose_name='Юридическое лицо'),
        ),
        migrations.AddField(
            model_name='animal',
            name='medical_checkup_date',
            field=models.DateTimeField(blank=True, help_text='Дата медосмотра', null=True, verbose_name='Дата медосмотра'),
        ),
        migrations.AddField(
            model_name='animal',
            name='owner_name',
            field=models.CharField(blank=True, help_text='ФИО опекунов', max_length=15, null=True, verbose_name='ФИО опекунов'),
        ),
        migrations.AddField(
            model_name='animal',
            name='parasites_treatment',
            field=models.TextField(blank=True, help_text='Введите данные об обработке от паразитов в формате: дата, название препарата, доза', max_length=500, null=True, verbose_name='Обработка от эндо- и эктопаразитов'),
        ),
        migrations.AddField(
            model_name='animal',
            name='person_owner_name',
            field=models.CharField(blank=True, help_text='ФИО физического лица', max_length=15, null=True, verbose_name='ФИО физического лица'),
        ),
        migrations.AddField(
            model_name='animal',
            name='region',
            field=models.CharField(help_text='Административный округ', max_length=10, null=True, verbose_name='Административный округ'),
        ),
        migrations.AddField(
            model_name='animal',
            name='sex',
            field=models.CharField(blank=True, choices=[('m', 'MALE'), ('f', 'FEMALE')], help_text='Пол', max_length=1, null=True, verbose_name='Пол'),
        ),
        migrations.AddField(
            model_name='animal',
            name='size',
            field=models.CharField(choices=[('s', 'Малый'), ('m', 'Средний'), ('l', 'Крупный')], default='средний', help_text='Размер', max_length=1, verbose_name='Размер'),
        ),
        migrations.AddField(
            model_name='animal',
            name='socialized',
            field=models.BooleanField(default=False, help_text='Социализировано (да/нет)', null=True, verbose_name='Социализировано'),
        ),
        migrations.AddField(
            model_name='animal',
            name='staff_name',
            field=models.CharField(blank=True, help_text='ФИО сотрудника по уходу', max_length=15, null=True, verbose_name='ФИО сотрудника по уходу'),
        ),
        migrations.AddField(
            model_name='animal',
            name='sterilization_date',
            field=models.DateTimeField(help_text='Дата стериллизации', null=True, verbose_name='Дата стериллизации'),
        ),
        migrations.AddField(
            model_name='animal',
            name='tail',
            field=models.CharField(choices=[('Обычный', 'Обычный'), ('Саблевидный ', 'Саблевидный '), ('Крючком ', 'Крючком '), ('Поленом ', 'Поленом '), ('Прутом ', 'Прутом '), ('Пером ', 'Пером '), ('Серпом', 'Серпом'), ('Кольцом', 'Кольцом'), ('Купированный', 'Купированный')], default='обычный', help_text='Хвост', max_length=25, verbose_name='Хвост'),
        ),
        migrations.AddField(
            model_name='animal',
            name='vaccinations',
            field=models.TextField(blank=True, help_text='Введите данные о вакцинации в формате: дата, вид вакцины, номер серии', max_length=500, null=True, verbose_name='Вакцины'),
        ),
        migrations.AlterField(
            model_name='animal',
            name='animal_accounting_card',
            field=models.CharField(help_text='Номер карточки учета животного', max_length=20, primary_key=True, serialize=False, unique=True, verbose_name='Карточка учета животного'),
        ),
        migrations.AddField(
            model_name='animal',
            name='shelter',
